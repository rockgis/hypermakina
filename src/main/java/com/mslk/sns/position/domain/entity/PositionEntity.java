package com.mslk.sns.position.domain.entity;
...
public class PositionEntity extends TimeEntity {
    ...
    @Builder
    public PositionEntity(Long id, String uid, String name, int seq, int syncUse, int del, String memo) {
        this.id = id;
        this.uid = uid;
        this.name = name;
        this.seq = seq;
