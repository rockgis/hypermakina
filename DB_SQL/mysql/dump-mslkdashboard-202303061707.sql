...
CREATE TABLE `codemng` (
  ...
  `CODE_NM` varchar(50) CHARACTER SET utf8mb4  NOT NULL DEFAULT 'CODE 이름' COMMENT 'CODE 이름',
  `CODE_VM` varchar(50) CHARACTER SET utf8mb4  DEFAULT NULL COMMENT 'CODE 값',
  ...
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='code 관리';
...
CREATE TABLE `dashboardmng` (
  ...
  `SE_TF` char(1) NOT NULL DEFAULT 'Y' COMMENT '사용유무',
  `DSB_NOTE` varchar(30) CHARACTER SET utf8mb4  DEFAULT NULL COMMENT 'META Host 비고',
  `ALT_EN` varchar(30) DEFAULT NULL COMMENT '수정 ID',
  `CREATED_DATE` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '등록일시',
  `MODIFIED_DATE` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '수정일시',
  PRIMARY KEY (`ID`)
...
INSERT INTO `dashboardmng` VALUES (5,'EGM','SNS 자원사용량','SYSTEM 기반의 자원 모니터링 ','SYSTEM','연관 시스템의 자원 사용량 ','/sns/dashboard?idx=1','Y','업무 시스템 기반의 자원 사용량 모니터링 ','admin','2023-02-13 00:04:03',NULL),(6,'EGM','SNS DB  모니터링 ','DB 시스템의 자원 사용량 ','DB','DB 자원 사용량 ','/sns/dashboard?idx=2','Y','','admin','2023-02-23 07:29:00',NULL),(7,'EGM','NetWork Dashboard','Network 다이어그램을 통한 데이타 확인','NETWORK','Network 기반의 데이터 사용량','/sns/dashboard?idx=3','Y','','admin','2023-03-03 01:32:58',NULL),(8,'EGM','WAS DashBoard','WAS 모니터링','WAS','WAS 시스템 모니터링','/sns/dashboard?idx=4','Y','JMX 기반의 데이터 모니터링 ','admin','2023-03-06 05:06:29',NULL);
...
CREATE TABLE `egmmeta` (
  `ID` int NOT NULL AUTO_INCREMENT COMMENT '등록순번',
  `META_TYPE` varchar(50) CHARACTER SET utf8mb4  NOT NULL DEFAULT 'egmanager' COMMENT 'META TYPE 정보',
...
INSERT INTO `egmmeta` VALUES (1,'DB','MES DB #1','MES Tibero DBMS','Dell','MES','MES DBMS','','Windows 2019 Std','192.168.10.210','OS','','admin','2023-02-09 02:14:53',NULL),(2,'DB','MES DB #2','MES Tibero DBMS','Dell','MES','MES DBMS','','Windows 2019 Std','192.168.10.211','OS','','admin','2023-02-09 02:14:53',NULL),(3,'WAS','MES APP Server #1','MES 웹 서버','Dell','MES','MES WAS','','Windows 2019 Std','192.168.10.213','OS','','admin','2023-02-09 02:14:53',NULL),(4,'APP','MES APP Server #2','MES App Aserver #1','Dell','MES','MES C/S inf','','Windows 2019 Std','192.168.10.214','OS','','admin','2023-02-09 02:14:53',NULL),(5,'APP','MES APP Server #3','MES App Aserver #2','Dell','MES','MES C/S inf','','Windows 2019 Std','192.168.10.215','OS','','admin','2023-02-09 02:14:53',NULL),(6,'APP','MES APP Server #4','','Dell','MES','','','Windows 2019 Std','192.168.10.216','OS','','admin','2023-02-09 02:14:53',NULL),(7,'SYSTEM','EAP Server','문서 중앙화','Dell','SMM','문서 보안','','Centos 7.9','192.168.10.237','OS','','admin','2023-02-09 02:14:53',NULL),(8,'SYSTEM','Docker Server','다기능 서버','','','SMS , Remote , Maria DB','','Centos 8 Stream','192.168.10.55','OS','','admin','2023-02-09 02:14:53',NULL),(9,'SYSTEM','Esxi Server','가상화 서버','Supermicro','SMM','FMC,MSSQL,DEV','','esxi 67u3','192.168.10.50','OS','','admin','2023-02-09 02:14:53',NULL),(10,'SYSTEM','FMC Server','IPS Mgmt','Firewall Management Center','SMM','IPS 보안 관리','','7.2.0.1','192.168.10.51','OS','','admin','2023-02-09 02:14:53',NULL),(11,'SYSTEM','IPS F/W','IPS','Firepower 2110 with FTD','SMM','IPS 방화벽','','7.2.0.1','192.168.10.53','OS','','admin','2023-02-09 02:14:53',NULL),(12,'SYSTEM','MS SQL Server','MSSQL DBMS','Vmware','ERP','ERP , ESD DBMS','','Windows 2022 Std','192.168.10.236','OS','','admin','2023-02-09 02:14:53',NULL),(13,'SYSTEM','MDS Server','Malware Defence','MDS4000','SMM','IDS 보안관리','','2.1.19.15(build 1200)','192.168.10.40','OS','','admin','2023-02-09 02:14:53',NULL),(14,'SYSTEM','EPP Server','Ahnlab 통합 플랫폼','Dell','SMM','Ahnlab 통합 보안','','','192.168.10.41','OS','','admin','2023-02-09 02:14:53',NULL),(15,'SYSTEM','DLP Server','문서 유출 방지','Dell','SMM','문서 유출 방지','','Centos 7.9.2009','192.168.10.64','OS','','admin','2023-02-09 02:14:53',NULL),(16,'SYSTEM','EDR Server','위험탐지','Dell','SMM','위험 탐지','','','192.168.10.65','OS','','admin','2023-02-09 02:14:53',NULL);
...
CREATE TABLE `egmmetadata` (
  ...
  `SE_TF` char(1) CHARACTER SET utf8mb4  NOT NULL DEFAULT 'Y' COMMENT '사용유무',
  `ALT_EN` varchar(30) DEFAULT NULL COMMENT '수정 ID',
  `CREATED_DATE` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '등록일시',
  `MODIFIED_DATE` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '수정일시',
  PRIMARY KEY (`ID`),
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4  COMMENT='EGManger 대상 장비의 상세 정보 관리';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `egmmetadata` VALUES (1,5,'EGM','componentName','test','info','componentType','timeline','measure','Y','admin','2023-02-24 09:02:30',NULL),(2,5,'EGM','componentName','test','info','componentType','timeline','measure','Y','admin','2023-02-24 09:04:24',NULL),(3,1,'EGM','MES_Tibero_1_t','Memory Usage','','','','','Y','admin','2023-03-06 07:35:34',NULL);
...
CREATE TABLE `hyperrestapi` (
  ...
  `USR_EN` varchar(30) CHARACTER SET utf8mb4  NOT NULL DEFAULT 'admin' COMMENT '연결 ID',
  `USR_PW` varchar(30) NOT NULL DEFAULT 'bHlpanVuIUAwOQ==' COMMENT '연결 암호_base64',
  `MANAGERURL` varchar(30) CHARACTER SET utf8mb4  NOT NULL DEFAULT 'http://192.168.10.62:7077' COMMENT 'EG Mnager URL',
  `EGMMNGID` int DEFAULT NULL COMMENT 'EG MNG DATA ID',
  ...
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4  COMMENT='REST API 관리';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `mslkta0001` (
  ...
  `EM_NM` char(50) CHARACTER SET utf8mb4  DEFAULT NULL COMMENT '이메일',
...
CREATE TABLE `tb_department` (
  ...
  `uid` varchar(50) CHARACTER SET utf8mb4  DEFAULT NULL COMMENT ' 부서 ID',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4  COMMENT=' 부서 관리';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tb_position` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '고유 인덱스',
  `uid` varchar(50) CHARACTER SET utf8mb4  DEFAULT NULL COMMENT ' 직책 ID',
  ...
  `memo` text COMMENT '메모',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4  COMMENT='직책 관리';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tb_rank` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '고유 인덱스',
  `uid` varchar(50) CHARACTER SET utf8mb4  DEFAULT NULL COMMENT ' 직급 ID',
  ...
  `memo` text COMMENT '메모',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4  COMMENT='직급 관리';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tb_staff` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '고유 인덱스',
  `uid` varchar(50) CHARACTER SET utf8mb4  DEFAULT NULL COMMENT ' login ID',
  ...
  `hp` varchar(50) CHARACTER SET utf8mb4  DEFAULT NULL COMMENT '연락처',
  `seq` int DEFAULT NULL COMMENT '순서',
  `sync_use` int DEFAULT NULL COMMENT '동기화 유무 (0/1 , FALSE/TRUE)',
  ...
  `memo` text COMMENT '메모',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4  COMMENT='사용자 관리';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tb_sync_svr` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '고유 인덱스',
  `uid` varchar(50) CHARACTER SET utf8mb4  DEFAULT NULL COMMENT ' 서버 ID',
  ...
  `memo` text COMMENT '메모',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4  COMMENT='Sync 서버 관리';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-03-06 17:07:31
